...
main(int argc, char *argv[])
{
  ...
  4a:	89 c3                	mov    %eax,%ebx
	if(priority >= 0 && priority <= 100)
  4c:	77 1c                	ja     6a <main+0x6a>
	{
		printf(1, "pid = %d, priority = %d\n",process_id, priority);
  4e:	50                   	push   %eax
  4f:	56                   	push   %esi
  50:	68 50 07 00 00       	push   $0x750
  55:	6a 01                	push   $0x1
  ...
  5e:	53                   	push   %ebx
  5f:	56                   	push   %esi
  60:	e8 05 03 00 00       	call   36a <modifypriority>
	else
	{	
	...
	exit();
  65:	e8 58 02 00 00       	call   2c2 <exit>
		printf(1, "pid = %d, priority = %d\n",process_id, priority);
		modifypriority(process_id, priority);
	}
	else
  ...
  6a:	50                   	push   %eax
  6b:	50                   	push   %eax
  6c:	68 69 07 00 00       	push   $0x769
  71:	6a 02                	push   $0x2
  73:	e8 a8 03 00 00       	call   420 <printf>
		exit();
  78:	e8 45 02 00 00       	call   2c2 <exit>
  7d:	66 90                	xchg   %ax,%ax
  7f:	90                   	nop
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 7a 07 00 00       	mov    $0x77a,%eax
