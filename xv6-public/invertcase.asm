...
main(int argc, char *argv[])
{
  ...
  16:	c7 45 e0 01 00 00 00 	movl   $0x1,-0x20(%ebp)
#include "stat.h"
#include "user.h"
...
main(int argc, char *argv[])
{
  ...
  1f:	89 45 dc             	mov    %eax,-0x24(%ebp)
  22:	8b 41 04             	mov    0x4(%ecx),%eax
  for(int j=1;j<argc;j++)
  25:	83 fe 01             	cmp    $0x1,%esi
  28:	8d 78 04             	lea    0x4(%eax),%edi
  2b:	0f 8e 93 00 00 00    	jle    c4 <main+0xc4>
  31:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  {	
  	  int len = 0;
	  while(argv[j][len] != '\0') len++;
  38:	8b 1f                	mov    (%edi),%ebx
  3a:	31 d2                	xor    %edx,%edx
  3c:	80 3b 00             	cmpb   $0x0,(%ebx)
  3f:	74 5d                	je     9e <main+0x9e>
  41:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
  48:	83 c2 01             	add    $0x1,%edx
  4b:	80 3c 13 00          	cmpb   $0x0,(%ebx,%edx,1)
  4f:	75 f7                	jne    48 <main+0x48>
  51:	31 c0                	xor    %eax,%eax
  53:	89 55 e4             	mov    %edx,-0x1c(%ebp)
  56:	89 de                	mov    %ebx,%esi
  58:	eb 19                	jmp    73 <main+0x73>
  ...
  60:	88 19                	mov    %bl,(%ecx)
	   		argv[j][i] += 'A';
  62:	8b 17                	mov    (%edi),%edx
  64:	01 c2                	add    %eax,%edx
  66:	80 02 41             	addb   $0x41,(%edx)
  69:	8b 37                	mov    (%edi),%esi
{
  for(int j=1;j<argc;j++)
  {	
  	  int len = 0;
  ...
  6e:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  71:	74 29                	je     9c <main+0x9c>
	  {
	   	if(argv[j][i] - 'a' >= 0 && argv[j][i] - 'a' < 26)
  73:	8d 0c 06             	lea    (%esi,%eax,1),%ecx
  76:	0f b6 11             	movzbl (%ecx),%edx
  79:	8d 5a 9f             	lea    -0x61(%edx),%ebx
  7c:	80 fb 19             	cmp    $0x19,%bl
  7f:	76 df                	jbe    60 <main+0x60>
	   	{
	   		argv[j][i] -= 'a';
	   		argv[j][i] += 'A';
	   	}
	   	else if(argv[j][i] - 'A' >= 0 && argv[j][i] - 'A' < 26)
  81:	83 ea 41             	sub    $0x41,%edx
  84:	80 fa 19             	cmp    $0x19,%dl
  87:	77 e2                	ja     6b <main+0x6b>
	   	{
	   		argv[j][i] -= 'A';
  89:	88 11                	mov    %dl,(%ecx)
	   		argv[j][i] += 'a';
  8b:	8b 17                	mov    (%edi),%edx
  8d:	01 c2                	add    %eax,%edx
{
  for(int j=1;j<argc;j++)
  {	
  	  int len = 0;
  ...
  92:	80 02 61             	addb   $0x61,(%edx)
{
  ...
  {	
	  ...
	  while(argv[j][len] != '\0') len++;
	  for(int i=0;i<len;i++)
  95:	39 45 e4             	cmp    %eax,-0x1c(%ebp)
  98:	8b 37                	mov    (%edi),%esi
  9a:	75 d7                	jne    73 <main+0x73>
  9c:	89 f3                	mov    %esi,%ebx
	   	{
	   		argv[j][i] -= 'A';
	   		argv[j][i] += 'a';
	   	} 
  ...
  a1:	83 c7 04             	add    $0x4,%edi
  a4:	53                   	push   %ebx
  a5:	68 a0 07 00 00       	push   $0x7a0
  aa:	6a 01                	push   $0x1
...
{
  for(int j=1;j<argc;j++)
  b1:	83 45 e0 01          	addl   $0x1,-0x20(%ebp)
  b5:	83 c4 10             	add    $0x10,%esp
  b8:	8b 45 e0             	mov    -0x20(%ebp),%eax
  bb:	39 45 dc             	cmp    %eax,-0x24(%ebp)
  be:	0f 85 74 ff ff ff    	jne    38 <main+0x38>
	   		argv[j][i] += 'a';
	   	} 
	  }
  	  printf(1, "%s ", argv[j]);
  ...
  c7:	68 a4 07 00 00       	push   $0x7a4
  cc:	6a 01                	push   $0x1
  ce:	e8 ad 03 00 00       	call   480 <printf>
  exit();
  d3:	e8 4a 02 00 00       	call   322 <exit>
  d8:	66 90                	xchg   %ax,%ax
  da:	66 90                	xchg   %ax,%ax
  dc:	66 90                	xchg   %ax,%ax
  de:	66 90                	xchg   %ax,%ax
...
000003ca <modifypriority>:
SYSCALL(modifypriority)
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41f:	f7 f6                	div    %esi
 421:	0f b6 92 b0 07 00 00 	movzbl 0x7b0(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 598:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 59b:	b8 a6 07 00 00       	mov    $0x7a6,%eax
...
free(void *ap)
{
 ...
 621:	a1 54 0a 00 00       	mov    0xa54,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 677:	89 08                	mov    %ecx,(%eax)
  freep = p;
 679:	a3 54 0a 00 00       	mov    %eax,0xa54
}
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 54 0a 00 00    	mov    0xa54,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 70f:	76 3f                	jbe    750 <malloc+0xa0>
    ...
    if(p == freep)
 711:	39 05 54 0a 00 00    	cmp    %eax,0xa54
 ...
 736:	e8 e5 fe ff ff       	call   620 <free>
  return freep;
 73b:	8b 15 54 0a 00 00    	mov    0xa54,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 75f:	89 15 54 0a 00 00    	mov    %edx,0xa54
      return (void*)(p + 1);
 ...
 774:	eb e9                	jmp    75f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 776:	c7 05 54 0a 00 00 58 	movl   $0xa58,0xa54
 77d:	0a 00 00 
 780:	c7 05 58 0a 00 00 58 	movl   $0xa58,0xa58
 787:	0a 00 00 
    base.s.size = 0;
 78a:	b8 58 0a 00 00       	mov    $0xa58,%eax
 78f:	c7 05 5c 0a 00 00 00 	movl   $0x0,0xa5c
 796:	00 00 00 
